...
define(
    [
        ...
        'https://hosted.subscribepro.com/payment-fields/payment-fields-0.9.4.js',
        'mage/translate'
    ],
    function ($, Component, CcForm, config, getOrderStatus, quote, customer,placeOrder, redirectOnSuccessAction, PaymentFields, $t) {
        'use strict';
