...
class TransactionIdHandlerTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    protected $transactionIdHandler;
    ...
    protected function setUp()
    {
        ...
        $this->transactionIdHandler = $objectManagerHelper->getObject(
            'Swarming\SubscribePro\Gateway\Response\TransactionIdHandler',
            [
    ...
    public function testHandle()
    {
        ...
        $paymentInfoMock->expects($this->once())->method('setIsTransactionClosed')->with(false);
        $paymentInfoMock->expects($this->once())->method('setShouldCloseParentTransaction')->with(false);
